...
REN "Customized_UART_protocol.so" "Customized UART protocol3.so"
COPY  /y  "Customized UART protocol3.so"  "..\..\lib\plc"
COPY  /y  "Customized UART protocol3.dll"  "..\..\lib\plc"
COPY  /y  "Customized UART protocol3.ge"  "..\..\lib\plc"

rename "Customized UART protocol3.so" drv_p0.so
DEL "COMx.o"
pause